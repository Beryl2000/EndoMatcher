...
import timm
import pytest
from timmvit.timm.utils.model import freeze, unfreeze
from timmvit.timm.utils.model import ActivationStatsHook
from timmvit.timm.utils.model import extract_spp_stats

from timmvit.timm.utils.model import _freeze_unfreeze
from timmvit.timm.utils.model import avg_sq_ch_mean, avg_ch_var, avg_ch_var_residual
from timmvit.timm.utils.model import reparameterize_model
from timmvit.timm.utils.model import get_state_dict
...
def test_freeze_unfreeze_bn_root():
    ...
    from timmvit.timm.layers import BatchNormAct2d
