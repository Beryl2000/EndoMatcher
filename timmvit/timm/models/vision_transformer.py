...
from timmvit.timm.data import IMAGENET_DEFAULT_MEAN, IMAGENET_DEFAULT_STD, IMAGENET_INCEPTION_MEAN, IMAGENET_INCEPTION_STD, \
    OPENAI_CLIP_MEAN, OPENAI_CLIP_STD
from timmvit.timm.layers import PatchEmbed, Mlp, DropPath, AttentionPoolLatent, RmsNorm, PatchDropout, SwiGLUPacked, \
...
class CrossAttention(nn.Module):
    def __init__(self, dim, num_heads, qkv_bias=False, qk_norm: bool = False, attn_drop=0., proj_drop=0., norm_layer: nn.Module = nn.LayerNorm,):
        super().__init__()
        self.num_heads = num_heads
        self.head_dim = dim // num_heads
        self.scale = self.head_dim ** -0.5
