...
Modified from timmvit.timm/models/vision_transformer.py
"""
...
from timmvit.timm.layers import PatchEmbed, Mlp, DropPath, to_2tuple, trunc_normal_, _assert, LayerNorm
