...
from timmvit.timm.layers import Conv2dSame, ScaledStdConv2dSame, CondConv2d, StdConv2dSame, Format
from timmvit.timm.layers import resample_abs_pos_embed, resample_abs_pos_embed_nhwc
from timmvit.timm.layers.non_local_attn import BilinearAttnTransform
from timmvit.timm.layers.pool2d_same import MaxPool2dSame, AvgPool2dSame
from timmvit.timm.layers.norm_act import (
    BatchNormAct2d,
    SyncBatchNormAct,
...
# NOTE: By default, any modules from timmvit.timm.models.layers that we want to treat as leaf modules go here
# BUT modules from timmvit.timm.models should use the registration mechanism below
_leaf_modules = {
...
try:
    from timmvit.timm.layers import InplaceAbn
